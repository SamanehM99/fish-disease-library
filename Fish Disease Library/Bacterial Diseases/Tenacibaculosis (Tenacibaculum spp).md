...
| ***T. finnmarkense***            | - **Antibiotics**: Rarely used to treat against tenacibaculosis in Norway due to limited effect. Florfenicol is the main antibiotic used when treatment is needed, but is strictly regulated through veterinary prescription and national monitoring systems [2](https://www.vetinst.no/sykdom-og-agens/tenacibaculose).<br>- **Vaccine**: No vaccines, but development work underway [47](https://nofima.no/fakta/verdt-a-vite-om-bakterielle-sar-pa-laks/).      - **Alternatives**: Research shows gradual acclimation to seawater (e.g., brackish water pre-adaptation) can reduce outbreak severity and improve survival [49](https://www.sciencedirect.com/science/article/pii/S0044848625010609). | Research into non-injection immunisation with recombinant antigen proteins in combination with probiotics [30](https://www.fhf.no/prosjekter/prosjektbasen/901655/)​ |
