---
title: Vibriosis
description: Learn about Vibriosis, a bacterial disease caused by Vibrio species affecting farmed and wild fish worldwide. Discover symptoms, diagnosis, treatment options, and prevention strategies.
tags:
  - Vibriosis
  - BacterialDiseases
  - Bacteria
...
Vibriosis is a collective term for bacterial diseases caused by pathogenic species of the genus *Vibrio*, and in aquaculture it often also includes the closely related genus *Aliivibrio*. These are gram-negative, asporogenous rods that are ubiquitous inhabitants of marine and estuarine environments worldwide. The disease is also referred to as "vibriosis" generically, with species-specific names such as *Vibrio anguillarum* infection, "red pest" or "red disease of eels," and luminescent vibriosis (for bioluminescent species). In severe form, the systemic presentation is known as haemorrhagic septicaemia [1](https://doi.org/10.3389/fmicb.2022.904815).

The most clinically significant species in marine aquaculture are *V. anguillarum*, *V. ordalii*, *V. vulnificus*, *V. alginolyticus*, *V. harveyi*, *V. parahaemolyticus*, and *Aliivibrio salmonicida* (formerly *V. salmonicida*). More than 130 recognized *Vibrio* species exist, grouped into 14 clades, including commensal, mutualistic, and pathogenic forms [1](https://doi.org/10.3389/fmicb.2022.904815). Two fish‑pathogenic bacteria from this group are particularly important in Norwegian waters: *Vibrio anguillarum*, which causes "classical vibriosis", and *Aliivibrio salmonicida* (formerly *Vibrio salmonicida*), which causes "cold‑water vibriosis/Hitra disease" [15](https://www.vetinst.no/sykdom-og-agens/Kaldtvannsvibriose).

Vibriosis affects a broad range of commercially important marine fish species, compromising both wild an reared fish, including gilthead seabream (*Sparus aurata*), European seabass (*Dicentrarchus labrax*), Atlantic salmon (*Salmo salar*), rainbow trout (*Oncorhynchus mykiss*) Atlantic cod (*Gadus morhua*), turbot (*Scophthalmus maximus*), Asian seabass (*Lates calcarifer*), tilapia, and numerous flatfish species. Shellfish, crustaceans, mollusks, corals, and rotifers are also severely affected [16](https://pubmed.ncbi.nlm.nih.gov/30246889/) All cultured marine fish may, to varying degrees, host opportunistic *Vibrio* species [1](https://doi.org/10.3389/fmicb.2022.904815).

Vibriosis is one of the most widespread and devastating bacterial diseases in global aquaculture. In 1997, the World Bank estimated disease losses in aquaculture at US$3 billion per year, with *Vibrio* spp. playing an important role in those losses. By approximately 2017, estimates had doubled to over US$6 billion annually [1](https://doi.org/10.3389/fmicb.2022.904815).

*Vibrio* infections are particularly devastating during the early, larval stages of development, where they are a common cause of high mortality rates, and outbreaks can lead to the loss of entire populations within a single aquaculture system. The ongoing rise of antibiotic resistance among *Vibrio* species, linked to both climate change and intensive aquaculture practices, has made vibriosis an increasingly urgent global challenge [1](https://doi.org/10.3389/fmicb.2022.904815) [2](https://doi.org/10.1016/j.jgeb.2025.100522).
...
- **Physical Signs:**
    - **Haemorrhagic Septicaemia:** Extensive external and internal haemorrhages, particularly at the base of fins, operculum, and ventral surface are a hallmark sign of acute vibriosis. The infection often becomes systemic, with haemorrhages in internal organs such as the pyloric caeca, abdominal fat, musculature and liver [1](https://doi.org/10.3389/fmicb.2022.904815) [16](https://pubmed.ncbi.nlm.nih.gov/30246889/).
    - **Skin Ulcers and Lesions:** External skin ulcers, focal necrosis, and erosion of the tail are characteristic of advanced infection [1](https://doi.org/10.3389/fmicb.2022.904815).
    - **Dark Pigmentation:** Affected fish exhibit abnormal darkening of the skin [1](https://doi.org/10.3389/fmicb.2022.904815).
    - **Exophthalmos:** Protruding or "pop-eye" appearance due to fluid accumulation behind the eye [1](https://doi.org/10.3389/fmicb.2022.904815).
    - **Splenomegaly:** Marked enlargement of the spleen observed at post-mortem [1](https://doi.org/10.3389/fmicb.2022.904815).
    - **Pale Kidney:** Renal discoloration indicating organ compromise [1](https://doi.org/10.3389/fmicb.2022.904815).
    - **Skeletal Deformity (Lordosis):** Spinal curvature reported in chronically affected fish [1](https://doi.org/10.3389/fmicb.2022.904815).
    - **Organ Necrosis:** Multifocal areas of cell death commonly observed in the gill, liver, spleen and kidney, where affected foci appear pale and poorly demarcated [1](https://doi.org/10.3389/fmicb.2022.904815) [16](https://pubmed.ncbi.nlm.nih.gov/30246889/). 
    - **Ascites**: Accumulation of clear or bloody fluid in the abdominal cavity, often leading to a swollen abdomen [1](https://doi.org/10.3389/fmicb.2022.904815). 

- **Behavioural Changes:**
    - **Lethargy:** Reduced activity and slow, labored swimming where they tend to swim near the surface of the water [1](https://doi.org/10.3389/fmicb.2022.904815) [16](https://pubmed.ncbi.nlm.nih.gov/30246889/).
    - **Loss of Appetite:** Significant reduction in feed intake and associated weight loss [1](https://doi.org/10.3389/fmicb.2022.904815).
    - **Erratic Swimming:** Disoriented movement patterns in acutely affected fish [1](https://doi.org/10.3389/fmicb.2022.904815).

**Progression of Clinical Signs**

- **Early Stages:** Subtle, non-specific signs including mild reduction in feed intake, slight lethargy, and skin discoloration [16](https://pubmed.ncbi.nlm.nih.gov/30246889/). Fish may appear clinically normal while harboring significant bacterial loads. Disease onset is often linked to environmental stressors such as rising water temperature, handling, or deteriorating water quality [1](https://doi.org/10.3389/fmicb.2022.904815).
- **Advanced Stages:** Pronounced haemorrhagic septicaemia with extensive skin lesions, complete erosion of the tail, exophthalmic eyes, and gross internal organ pathology. Acute outbreaks can cause sudden and catastrophic mortality. Regardless of host developmental stage, *Vibrio* infections may occur suddenly and can lead to the loss of the entire population reared in a given system [1](https://doi.org/10.3389/fmicb.2022.904815).
- **Impact on Fish Health:** Vibriosis severely compromises immune function and overall vitality. Mortality rates vary widely depending on the causative species, water temperature, and host susceptibility. *V. harveyi* was shown to be prevalent and causing disease year-round across multiple fish species and geographic regions in long-term surveillance [3](https://doi.org/10.3390/microorganisms11051197).
...
- **Causative Agent:** *Vibrio* spp. are Gram-negative rod-shaped and motile via one or more polar flagella. They are mesophilic, with facultative fermentative metabolism. With the exception of *V. cholerae* and *V. mimicus*, *Vibrio* species are halophilic, commonly occurring at 30–35 ppt salinity, though their ability to thrive in estuarine environments is well documented [1](https://doi.org/10.3389/fmicb.2022.904815). 
 - Clinically important *Aliivibrio salmonicida* (formerly *V. salmonicida*), the cause of cold‑water vibriosis in salmonids, shares these general features but is adapted to low seawater temperatures (grows best at 12-15°C) [15](https://www.vetinst.no/sykdom-og-agens/Kaldtvannsvibriose).
 - *V. anguillarum* is one of the best-characterized fish pathogen, and is highly adaptable and occurs in several serotypes but O1, O2, and O3 are the serotypes most consistently associated with fish vibriosis [2](https://doi.org/10.1016/j.jgeb.2025.100522).
    
- **Key Virulence Factors:** Pathogenic *Vibrio* spp. produce a diverse arsenal of virulence factors including enterotoxins, haemolysins, cytotoxins, proteases, lipases, phospholipases, siderophores, and adhesive factors/haemagglutinins that allow them to adhere to fish epithelial cells, breach mucosal barriers, and colonize internal organs. *V. anguillarum* additionally encodes Type VI Secretion System (T6SS) components (hcp-2, vipB/mglB) and RTX toxins (rtxC). The small RNA VaRyhB plays a critical role in regulating iron homeostasis and siderophore biosynthesis, and deletion of this regulatory RNA results in reduced pathogenicity, demonstrating its importance in establishing infection [4](https://doi.org/10.3390/vetsci12040327) [6](https://doi.org/10.3389/fcimb.2024.1531176).
    
- **Transmission Methods:**
    
    - **Horizontal Transmission:** Water-borne transmission is the primary route. *Vibrio* spp. are free-living in the water column and sediment, entering fish via gill epithelium, skin abrasions, or the digestive tract during feeding. Live feed organisms such as rotifers (*Brachionus* spp.) and *Artemia* are documented carriers of *V. anguillarum*, *V. alginolyticus*, *V. parahaemolyticus*, *V. harveyi*, and other species, making larval rearing systems particularly high-risk environments [1](https://doi.org/10.3389/fmicb.2022.904815).
    - **Vertical Transmission:** Not well established for *Vibrio* spp., though environmental contamination of eggs is possible.
    - **Vector/Environmental Transmission:** *Vibrio* species are ubiquitous in marine and estuarine environments. They thrive in association with zooplankton, shellfish, crustaceans, benthic invertebrates and tank biofilms, serving as persistent environmental reservoirs. Organic matter-enriched water in intensive aquaculture systems favors rapid *Vibrio* proliferation [1](https://doi.org/10.3389/fmicb.2022.904815).

**Risk Factors**

- **Environmental Factors:** Temperature is the main environmental driver of fish vibriosis, but its effect is species-specific. Many *Vibrio* spp. proliferate and cause more outbreaks during warmer spring and summer conditions, and field studies often identify temperature-seasonality as the strongest epidemiologic risk factor [1](https://doi.org/10.3389/fmicb.2022.904815). However, *V. anguillarum* can also cause disease in cold water aquaculture, and *A. salmonicida* causes cold-water vibriosis where disease usually develops when seawater is below 12°C [17](https://journals.asm.org/doi/10.1128/aem.01239-14). Salinity in the range of 30–35 ppt and high organic loading further support pathogen growth [1](https://doi.org/10.3389/fmicb.2022.904815). Climate change is predicted to increase the frequency and geographic range of vibriosis outbreaks [1](https://doi.org/10.3389/fmicb.2022.904815).
...
- **Clinical Examination:** Gross lesion examination focuses on the characteristic combination of haemorrhagic septicaemia (blood poisoning), external skin ulcers, darkened coloration, exophthalmos, splenomegaly, and pale kidney and gills (anaemia). However, clinical signs alone are not sufficient for species-level diagnosis given the broad overlap with other bacterial pathogens and vary among *Vibrio* species. Isolation of the causative agent from affected tissues (liver, spleen, kidney) is required for definitive diagnosis [1](https://doi.org/10.3389/fmicb.2022.904815).
...
- **Laboratory Tests:**
    ...
    - **PCR-Based Methods:** Molecular identification using species-specific target genes encoding virulence factors (toxR, toxS, haemolysin, collagenase, or genes from pathogenicity islands) offers superior species-level discrimination. A TaqMan probe-based multiplex real-time PCR assay has been validated for the simultaneous detection of *V. anguillarum*, *V. alginolyticus*, *V. harveyi*, and *V. scophthalmi* in a single reaction, with 100× greater sensitivity than conventional PCR and results within one hour [4](https://doi.org/10.3390/vetsci12040327). Real-time qPCR targeting the *groEL* gene effectively detects and quantifies *V. alginolyticus*, *Listonella anguillarum* (syn. *V. anguillarum*), and *V. harveyi* with detection limits as low as 48 CFU/mL [5](https://doi.org/10.3390/microorganisms10102060).
    - **Serological Methods:** Agglutination tests and ELISA targeting *Vibrio*-specific antigens (e.g., LPS) are used for serovar typing (particularly O1, O2, O3 for *V. anguillarum*) and for monitoring immune responses in vaccination trials [9](https://doi.org/10.3389/fimmu.2025.1579541).
    - **MALDI-TOF Mass Spectrometry:** MALDI-TOF MS offers rapid, cost-effective, and automated identification of *Vibrio* isolates without the need for highly trained operators. Accuracy depends critically on database completeness; combined use of the Luvibase and Bruker databases has achieved successful identification of diverse *Vibrio* species. MALDI-TOF MS is increasingly used alongside molecular methods in routine aquaculture diagnostics [1](https://doi.org/10.3389/fmicb.2022.904815).
    - **Histopathology:** Tissue section examination reveals focal necrosis of liver, kidney, and spleen, with bacterial aggregates in affected tissues [1](https://doi.org/10.3389/fmicb.2022.904815). Immunohistochemistry can be applied to demonstrate *Vibrio* antigens in situ and support species‑level diagnosis [15](https://www.vetinst.no/sykdom-og-agens/Kaldtvannsvibriose).

**Differential Diagnosis**

- **Distinguishing Vibriosis from Other Diseases:** Clinical signs of vibriosis overlap significantly with other bacterial infections, such as furunculosis (*Aeromonas salmonicida*), pasteurellosis (*Photobacterium damselae* subsp. *piscicida*), tenacibaculosis (*Tenacibaculum* spp.), and yersiniosis (*Yersinia ruckeri*). Infectious salmon anaemia (ISA) can give similar patterns of general haemorrhages. Definitive differentiation requires bacterial culture with biochemical or molecular characterization. The multiplex PCR approach allows simultaneous exclusion of multiple *Vibrio* species, while MALDI-TOF MS enables broad-spectrum pathogen identification from the same sample [1](https://doi.org/10.3389/fmicb.2022.904815) [4](https://doi.org/10.3390/vetsci12040327)[15](https://www.vetinst.no/sykdom-og-agens/Kaldtvannsvibriose).
...
- **Current Treatments:**
    ...
    - **Antibiotics:** Oxytetracycline is historically the most widely used antibiotic in aquaculture for vibriosis, both prophylactically and therapeutically. Florfenicol is also approved for use in several major producing countries. Most *Vibrio* species, including *Aliivibrio salmonicida*, retain sensitivity to tetracycline, oxytetracycline, chloramphenicol, and florfenicol, though sensitivity profiles vary considerably across strains and geographic regions [1](https://doi.org/10.3389/fmicb.2022.904815). There is currently no international uniformization of antibiotic use approval, with licensing determined by each country's legislation [1](https://doi.org/10.3389/fmicb.2022.904815).
    - **Treatment Challenges:** Antibiotic resistance among *Vibrio* species is a growing and urgent concern. Resistance genes for tetracycline, quinolones, and carbapenems have been identified in *V. anguillarum* strains via genomic analysis [2](https://doi.org/10.1016/j.jgeb.2025.100522). A meta-analysis of resistance profiles across Mediterranean aquaculture facilities shows an increasing trend in multidrug resistance among *V. alginolyticus*, *V. harveyi*, *V. parahaemolyticus*, and *V. splendidus* over time. Resistance is often carried on mobile genetic elements (resistance plasmids and horizontal gene transfer), which makes it easy for resistance traits to spread between bacteria [1](https://doi.org/10.3389/fmicb.2022.904815). Antibiotic residue concentrations in seafood biomass frequently exceed maximum residue limits in major producing countries, underlining the need for improved surveillance [1](https://doi.org/10.3389/fmicb.2022.904815).
    - **Antimicrobial resistance in LMICs:** Across low- and middle-income countries (LMICs) in Africa and Asia, antimicrobial resistance in *Vibrio* species poses a particularly acute dual threat to aquaculture productivity and public health. Key AMR genes found across *V. parahaemolyticus*, *V. alginolyticus*, *V. vulnificus*, and *V. cholerae* isolates from fish, shellfish, and aquatic environments. Ampicillin resistance is near-universal in many surveyed regions, with resistance to tetracycline, ciprofloxacin, and trimethoprim/sulfamethoxazole also widely reported. In African nations such as Nigeria, isolates from river environments showed resistance to doxycycline (71–89%), erythromycin (86–100%), and tetracycline (86–100%). AMR is estimated to cause US$1 billion in losses annually across LMICs from *Vibrio*-related disease alone [13](https://doi.org/10.1002/vms3.70877).
- **Vaccines:**
    
    - **Commercial Vaccines:** Commercially available vibriosis vaccines include AquaVac™ Vibromax™ (for shrimp via *Artemia nauplii* bioencapsulation) and ALPHA JECT 3000 (PHARMAQ AS, Norway; intraperitoneal injection for adult fish). These products offer efficacy against the most common *V. anguillarum* serotypes and have been successfully deployed in salmonid aquaculture [1](https://doi.org/10.3389/fmicb.2022.904815). In addition, multicomponent vaccines such as ALPHA JECT micro 6 (PHARMAQ AS, Norway) and AquaVac® S7 vet (MSD Animal Health, Norway) include antigens against both *Aliivibrio salmonicida* (cold‑water vibriosis) and *Vibrio anguillarum*, and are used routinely to control against these infections in Norwegian salmon farming [15](https://www.vetinst.no/sykdom-og-agens/Kaldtvannsvibriose).
    - **Whole Cell Inactivated Vaccines:** A formalin-killed *V. harveyi* vaccine administered intraperitoneally to marine red hybrid tilapia resulted in 87% survival post-challenge, compared to 20% in unvaccinated controls. Vaccinated fish showed significantly elevated IgM antibody titers and lysozyme activity [7](https://doi.org/10.3390/vaccines8040734).
    - **Feed-Based Vaccines:** A field study of an oral feed-based inactivated vibriosis vaccine in cage-cultured Asian seabass demonstrated significantly enhanced innate immune responses (lysozyme activity), elevated serum and mucosal IgM levels, and improved growth performance over 16 weeks. Survival rate was 71.3% in vaccinated vs. 67.7% in non-vaccinated groups under field conditions [8](https://doi.org/10.3390/vaccines11010009).
    - **Bath Immunization:** Atlantic cod bath-immunized with formalin-fixed *V. anguillarum* serotype O2a developed protective IgM-mediated immunity, providing full protection against O2a challenge and partial protection against O2b. Passive transfer of purified IgM from immunized donors protected naïve fish, confirming the protective role of antibody-mediated immunity even in species lacking classical CD4 T-cell help [9](https://doi.org/10.3389/fimmu.2025.1579541).
    - **Vaccine Implementation:** The successful implementation of vaccination programs in Norway during the late 1980s — combined with a phase-out of prophylactic antibiotic use — is regarded as a model example of how vaccination can dramatically reduce antibiotic dependence in intensive fish farming [1](https://doi.org/10.3389/fmicb.2022.904815) [10](https://doi.org/10.3390/ani14182692). These commercial vaccines are administered to smolts well before sea transfer and have provided near‑complete control of the bacterial diseases included in the vaccine; virtually all Atlantic salmon entering sea cages in Norway today are vaccinated against vibriosis [15](https://www.vetinst.no/sykdom-og-agens/Kaldtvannsvibriose).

**Preventive Measures**

- **Biosecurity Protocols:**
    
    - Monitoring and controlling *Vibrio* loads in rearing water, live feed, and broodstock using molecular surveillance tools [1](https://doi.org/10.3389/fmicb.2022.904815).
    - Careful management of live feed (*Artemia*, rotifers) to minimize introduction of pathogenic *Vibrio* strains into larval rearing systems [1](https://doi.org/10.3389/fmicb.2022.904815).
    - Early application of vaccination programs for juvenile and adult fish; bath immunization as a practical method for large-scale or larval fish where injection is not feasible [9](https://doi.org/10.3389/fimmu.2025.1579541) [10](https://doi.org/10.3390/ani14182692).
- **Farm Management Practices:**
    
    - Reducing stocking density and minimizing handling stress, which increase susceptibility to opportunistic *Vibrio* infection [1](https://doi.org/10.3389/fmicb.2022.904815).
    - Maintaining optimal water quality parameters including temperature, salinity, dissolved oxygen, and limiting organic matter accumulation; high organic load and warm temperatures favour *Vibrio* growth [16](https://pubmed.ncbi.nlm.nih.gov/30246889/) [1](https://doi.org/10.3389/fmicb.2022.904815).
    - Probiotic supplements are increasingly used in some aquaculture systems as a supportive, antibiotic‑free way to stabilise the microbiota and compete with opportunistic pathogens like *Vibrio* and improve gut health and water quality. Selected strains that can compete with or inhibit *Vibrio* spp. (for example *Bacillus velezensis* and *Phaeobacter* spp.) have demonstrated efficacy in inhibiting *Vibrio* biofilm formation and growth in aquaculture‑relevant experimental systems, and are therefore considered promising probiotic candidates for future applications [1](https://doi.org/10.3389/fmicb.2022.904815).
-  **Measures under development**:
    - Exploring phage therapy as a pathogen-specific, environmentally targeted intervention, particularly for species or developmental stages where vaccination is not applicable [1](https://doi.org/10.3389/fmicb.2022.904815).
    - Novel biocontrol agents such as *Paratapes undulata* extract have shown promise in reducing *V. alginolyticus* infection in tilapia, improving growth by ~284% and reducing mortality by 75% in infected groups compared to untreated infected controls, through immune modulation and direct antimicrobial activity [14](https://doi.org/10.1038/s41598-025-01026-x).
...
- **Lessons Learned:**
    ...
    - The emergence of novel *Vibrio* species in vaccinated Atlantic salmon confirms that existing commercial vaccines may not protect against phylogenetically divergent strains, reinforcing the importance of regular pathogen characterization in each farming region [11](https://doi.org/10.3390/microorganisms11071736).
    - Live feed represents a critical but controllable vector for *Vibrio* introduction into larval systems; microbiome management of *Artemia* and rotifers is an important preventive lever [1](https://doi.org/10.3389/fmicb.2022.904815).
...
2. **"Pathogenic and Opportunistic *Vibrio* spp. Associated with Vibriosis Incidences in the Greek Aquaculture: The Role of *Vibrio harveyi* as the Principal Cause of Vibriosis"**  
    ...
    [DOI: 10.3390/microorganisms11051197](https://doi.org/10.3390/microorganisms11051197)
...
5. **"Comparative Genomic Analysis of a Novel *Vibrio* sp. Isolated from an Ulcer Disease Event in Atlantic Salmon (*Salmo salar*)"**  
    ...
    [DOI: 10.3390/microorganisms11071736](https://doi.org/10.3390/microorganisms11071736)
...
6. **"Development of Multiple Real-Time Fluorescent Quantitative PCR for *Vibrio* Pathogen Detection in Aquaculture"**  
    ...
    [DOI: 10.3390/vetsci12040327](https://doi.org/10.3390/vetsci12040327)
    
7. **"Real-Time PCR Protocol for Detection and Quantification of Three Pathogenic Members of the Vibrionaceae Family"**  
    ...
    [DOI: 10.3390/microorganisms10102060](https://doi.org/10.3390/microorganisms10102060)
...
9. **"Field Efficacy of a Feed-Based Inactivated Vaccine against Vibriosis in Cage-Cultured Asian Seabass, *Lates calcarifer*, in Malaysia"**  
    ...
    [DOI: 10.3390/vaccines11010009](https://doi.org/10.3390/vaccines11010009)
    
10. **"Current Challenges of Vaccination in Fish Health Management"**  
    ...
    [DOI: 10.3390/ani14182692](https://doi.org/10.3390/ani14182692)
...
11. **"Protective IgM-Mediated Immunity against *Vibrio anguillarum* in Atlantic Cod with Evolutionary Losses of mhc class II and cd4"**  
    ...
    [DOI: 10.3389/fimmu.2025.1579541](https://doi.org/10.3389/fimmu.2025.1579541)
    
12. **"Multi-Organ Transcriptomic Profiles and Gene-Regulation Network Underlying Vibriosis Resistance in Tongue Sole"**  
    ...
    [DOI: 10.1038/s41597-024-03651-z](https://doi.org/10.1038/s41597-024-03651-z)
...
13. **"Antibiotic Resistance and Pathogenicity of *Vibrio* Species in Aquaculture: Implications for Fish Health and Food Safety in LMICs"**  
    ...
    [DOI: 10.1002/vms3.70877](https://doi.org/10.1002/vms3.70877)
...
14. **"Innovative Vibriosis Control in Open Aquaculture: *Paratapes undulata* as a Sustainable Growth and Resistance Enhancer in Red Tilapia"**  
    ...
    [DOI: 10.1038/s41598-025-01026-x](https://doi.org/10.1038/s41598-025-01026-x)
...
[1] Sanches-Fernandes, G. M. M., Sá-Correia, I., & Costa, R. (2022). Vibriosis outbreaks in aquaculture: Addressing environmental and public health concerns and preventive therapies using gilthead seabream farming as a model system. *Frontiers in Microbiology*, *13*, 904815. [https://doi.org/10.3389/fmicb.2022.904815](https://doi.org/10.3389/fmicb.2022.904815) · [Full text](https://citations.gxl.ai/papers/PMC9309886)

[2] Shahed, K., Chakma, A., Bin Manjur, O. H., & Islam, S. I. (2025). Multiscale comparative pathogenomic analysis of *Vibrio anguillarum* linking serotype diversity, genomic plasticity and pathogenicity. *Journal of Genetic Engineering & Biotechnology*, *23*, 100522. [https://doi.org/10.1016/j.jgeb.2025.100522](https://doi.org/10.1016/j.jgeb.2025.100522) · [Full text](https://citations.gxl.ai/papers/PMC12210308)

[3] Triga, A., Smyrli, M., & Katharios, P. (2023). Pathogenic and opportunistic *Vibrio* spp. associated with vibriosis incidences in the Greek aquaculture: The role of *Vibrio harveyi* as the principal cause of vibriosis. *Microorganisms*, *11*(5), 1197. [https://doi.org/10.3390/microorganisms11051197](https://doi.org/10.3390/microorganisms11051197) · [Full text](https://citations.gxl.ai/papers/PMC10220884)

[4] Zhang, B., Qiu, Y., Shi, C., & Zhang, J. (2025). Development of multiple real-time fluorescent quantitative PCR for *Vibrio* pathogen detection in aquaculture. *Veterinary Sciences*, *12*(4), 327. [https://doi.org/10.3390/vetsci12040327](https://doi.org/10.3390/vetsci12040327) · [Full text](https://citations.gxl.ai/papers/PMC12030866)

[5] Costa, C., Ferreira, G. D., Simões, M., Silva, J. L., & Campos, M. J. (2022). Real-time PCR protocol for detection and quantification of three pathogenic members of the Vibrionaceae family. *Microorganisms*, *10*(10), 2060. [https://doi.org/10.3390/microorganisms10102060](https://doi.org/10.3390/microorganisms10102060) · [Full text](https://citations.gxl.ai/papers/PMC9609007)

[6] Li, Y., Yu, X., Li, P., Li, X., & Wang, L. (2025). Characterization of the *Vibrio anguillarum* VaRyhB regulon and role in pathogenesis. *Frontiers in Cellular and Infection Microbiology*, *14*, 1531176. [https://doi.org/10.3389/fcimb.2024.1531176](https://doi.org/10.3389/fcimb.2024.1531176) · [Full text](https://citations.gxl.ai/papers/PMC11790442)

[7] Abu Nor, N., Zamri-Saad, M., Md Yasin, I.-S., Salleh, A., Mustaffa-Kamal, F., Matori, M. F., & Azmai, M. N. A. (2020). Efficacy of whole cell inactivated *Vibrio harveyi* vaccine against vibriosis in a marine red hybrid tilapia (*Oreochromis niloticus* × *O. mossambicus*) model. *Vaccines*, *8*(4), 734. [https://doi.org/10.3390/vaccines8040734](https://doi.org/10.3390/vaccines8040734) · [Full text](https://citations.gxl.ai/papers/PMC7761788)

[8] Amir-Danial, Z., Zamri-Saad, M., Amal, M. N. A., Annas, S., Mohamad, A., Jumria, S., Manchanayake, T., Arbania, A., & Ina-Salwany, M. Y. (2023). Field efficacy of a feed-based inactivated vaccine against vibriosis in cage-cultured Asian seabass, *Lates calcarifer*, in Malaysia. *Vaccines*, *11*(1), 9. [https://doi.org/10.3390/vaccines11010009](https://doi.org/10.3390/vaccines11010009) · [Full text](https://citations.gxl.ai/papers/PMC9865705)

[9] Jonsson, A., López-Porras, A., Nørstebø, S. F., Guslund, N. C., Sørum, H., Qiao, S.-W., & Johansen, F.-E. (2025). Protective IgM-mediated immunity against *Vibrio anguillarum* in Atlantic cod with evolutionary losses of *mhc class II* and *cd4*. *Frontiers in Immunology*, *16*, 1579541. [https://doi.org/10.3389/fimmu.2025.1579541](https://doi.org/10.3389/fimmu.2025.1579541) · [Full text](https://citations.gxl.ai/papers/PMC12265950)

[10] Kumar, A., Middha, S. K., Menon, S. V., Paital, B., Gokarn, S., Nelli, M., Rajanikanth, R. B., Chandra, H. M., Mugunthan, S. P., Kantwa, S. M., Usha, T., Hati, A. K., Venkatesan, D., Rajendran, A., Behera, T. R., Venkatesamurthy, S., & Sahoo, D. K. (2024). Current challenges of vaccination in fish health management. *Animals*, *14*(18), 2692. [https://doi.org/10.3390/ani14182692](https://doi.org/10.3390/ani14182692) · [Full text](https://citations.gxl.ai/papers/PMC11429256)

[11] Ghasemieshkaftaki, M., Vasquez, I., Eshraghi, A., Gamperl, A. K., & Santander, J. (2023). Comparative genomic analysis of a novel *Vibrio* sp. isolated from an ulcer disease event in Atlantic salmon (*Salmo salar*). *Microorganisms*, *11*(7), 1736. [https://doi.org/10.3390/microorganisms11071736](https://doi.org/10.3390/microorganisms11071736) · [Full text](https://citations.gxl.ai/papers/PMC10385127)

[12] Chen, Q., Ma, X., Wang, J., Shi, M., Hu, G., Chen, S., & Zhou, Q. (2024). Multi-organ transcriptomic profiles and gene-regulation network underlying vibriosis resistance in tongue sole. *Scientific Data*, *11*, 775. [https://doi.org/10.1038/s41597-024-03651-z](https://doi.org/10.1038/s41597-024-03651-z) · [Full text](https://citations.gxl.ai/papers/PMC11269662)

[13] Hobe, A., Msolo, L., Ebomah, K. E., Jaja, I. F., Oguttu, J. W., & Okoh, A. I. (2026). Antibiotic resistance and pathogenicity of *Vibrio* species in aquaculture: Implications for fish health and food safety in LMICs. *Veterinary Medicine and Science*, *12*, e70877. [https://doi.org/10.1002/vms3.70877](https://doi.org/10.1002/vms3.70877) · [Full text](https://citations.gxl.ai/papers/PMC13098078)

[14] Mowafy, R. E., Megahed, H. M., Abou Khadra, S. H., Bakry, M. A., Moustafa, A. H., & El-Demerdash, A. S. (2025). Innovative vibriosis control in open aquaculture: *Paratapes undulata* as a sustainable growth and resistance enhancer in red tilapia. *Scientific Reports*, *15*. [https://doi.org/10.1038/s41598-025-01026-x](https://doi.org/10.1038/s41598-025-01026-x) · [Full text](https://citations.gxl.ai/papers/PMC12098663)
